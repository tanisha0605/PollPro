...
public class MainPage {
    ...
    public void mainPageView(int id) throws SQLException {
        ...
        next.setForeground(customcolor);
        addPanel.add(next);
        ...
        submit.setForeground(customcolor);
        ...
        cancel.setForeground(customcolor);
        addPanel.add(cancel);
        ...
        optionPanel.setBackground(customcolor);
